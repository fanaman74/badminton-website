      ...
      <div style={{ width: "100%", maxWidth: 380 }}>
        ...
        <div style={{
          ...
          <div style={{
            ...
            marginBottom: 20, border: "1px solid var(--line)",
          }}>
            <button
              type="button"
          ...
          <form action={formAction} style={{ display: "flex", flexDirection: "column", gap: 14 }}>
            ...
            {mode === "signup" && (
              <div>
                <label htmlFor="name" style={{ display: "block", fontFamily: "var(--font-body)", fontWeight: 700, fontSize: 13, color: "var(--ink)", marginBottom: 6 }}>
                  Full Name
                </label>
                <input
                  id="name"
